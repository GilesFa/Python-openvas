...
csvFilePath = r'C:\temp\2022 Q2 弱掃初掃結果清單.csv'
jsonFilePath =r'C:\temp\2022 Q2 弱掃初掃結果清單.json'
...
read_file = pd.read_excel (f"{excelFilePath}")
    ...
    with open(csvFilePath, 'r',  encoding='utf-8') as csvf: 
        with open(jsonFilePath, 'w', encoding='utf-8') as jsonf:
            ...
            for row in csvReader: 
                x = OrderedDict([('index', {"_index": f"{index_name}", "_id": f"{i}"})])      
