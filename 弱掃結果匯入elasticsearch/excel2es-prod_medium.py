...
csvFilePath = r'C:\temp\2022 Q2 弱掃初掃結果清單_Medium-level.csv'
jsonFilePath =r'C:\temp\2022 Q2 弱掃初掃結果清單_Medium-level.json'
...
read_file = pd.read_excel (f"{excelFilePath}", 'Medium-level')
